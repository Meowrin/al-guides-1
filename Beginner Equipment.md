...
- **Useful Ships:** Renown (Crutch), Cassina and Downes/Mahan class, Leander
- The only true farming map in chapter 1, as no other map drops blueprints. The heavy cruiser and battleship guns are practically guaranteed to be stronger than anything else you might have available. Renown isn't an especially flashy ship, but she performs adequately early game and is worth using if you pick her up. The Mahan class destroyers are noted for being usable farming ships for most of the game (due to their refit) due to their Bastimal Flames (regains some HP when hp is critically low) skill and low cost. Leander is useful with a CL FP buff and after her refit becomes quite strong for her cost. The 120mm single whose blueprints drop in this map, while not useful as an early-game weapon, is a potent end-game weapon for certain ships due to its high rate of fire.

#### 2-2
- **Useful Equipment:** Naval Camo, Blue Anti-Air Guns
- **Useful Ships:** Laffey, Javelin, Ayanami (JP), Z23 (CN/EN), Shouhou, Arizona, Mahan-class, Leander, Nevada and Oklahoma/Nevada class
- One of the absolute best grinding spots for newer players. Starting in chapter 2, the starter ships are available as map drops, with the starter ship collection providing both a gold rarity quintuple torpedo launcher and the fourth starter ship. Arizona and Shouhou are both healers, with Arizona in particular being the only healing battleship in the game. While most blue rarity map drop ships either aren't notable enough to warrant mention, or are readily accessible otherwise, Shouhou only drops in chapter 2 and is an incredibly potent ship, both early and later game as she boasts an offensive plane loadout. The Nevada class while not flashy, become quite strong for their low rarity post refit. The blue anti-air guns that drop here, while not particular noteworthy, are still useful for the upcoming chapter 3, which has some of the first maps that test your ability to survive in high-aviation fights.

#### 2-3
- **Useful Equipment:** Anti-Air Radar, Fire Extinguisher
- **Useful Ships:** Starter Collection, Shouhou, Nelson (Crutch), Norfolk (Equipment on her), Mahan-class, Leander, Nevada and Oklahoma/Nevada class
...
- **Useful Ships:** Starter Collection, Shouhou, Rodney(crutch), Leander, Nevada class
...
- **Useful Ships:** Starter Collection, Charles Ausburne (collection), Souryuu and Hiryuu (Dragons), Mahan-class, Leander, Nevada class, Ranger, Langley
- Easily one of the best early-game farming maps. What 2-2 gives you in ship drops, 3-2 gives you in equipment drops. Every single piece of gear here is useful with the exception of the 102mm destroyer gun. while 3-1 and 3-3 give okay drops, any blueprint acquired from those maps is a blueprint not acquired from 3-2. For ship drops, Charles Ausburne is part of the Beaver collection, and the hardest to acquire, being a purple rarity ship. Dragons are often overlooked compared to the Foxes from 3-4, but are significantly easier to acquire, have comparable performance in PvE, and have remodels which make them substantially better for late-game PvE. Ranger is an inexpensive offensive carrier who after refit has the potential for large amounts of damage via her skills possibly chain-porcing. Langley's the opposite with a defensive planeload out, but this and her refit makes her a very affordable answer to planes and ACV woes. Her carrier experience boost being useful in building up fellow carriers.

#### 3-4
- **Useful Equipment:** Toolbox, F4U Corsair, 152mm twin
- **Useful Ships:** Starter Collection, Akagi and Kaga (Foxes), Kagerou, Mahan-class, Nevada-class, Langley, Ranger, Portland
- The most popular early-game farming maps. While the equipment can be useful, 3-2 is a more efficient map to farm if that's what you're after. The main reason 3-4 is a popular farming spot is the Foxes. Overall not as efficient a spot to farm as 3-2. While Foxes are strong, they're significantly harder to farm than Dragons, and can be acquired through chapter 3's SOS mission. This is the first map in this guide that drops Kagerou who for her rarity is quite strong and boasts a DD Torpedo buff that applies to any frontline ship class. Portland is a decent tank which becomes dramatically better with her refit, and hitting harder than any other early game tanking CA.

#### 4-2
- **Useful Equipment:** 152mm Triple, 120mm Twin, 40mm Quad Pom-Pom, 203mm Mounted, 150mm Twin TbtsK
- **Useful Ships:** Starter Collection, Shiranui, London, Leander, Langley, Shigure
- As with 3-2, every single equipment drop from here is useful. All five drops are T3 and only the pom-pom has a readily accessible replacement. Shiranui, similar to Shouhou, is a low-rarity ship that only drops in chapter 4. While she's not as universally useful as Shouhou or as strong as her sister Kagerou, she is still pretty strong in her own right after her refit. London, meanwhile, roughly comparable to refitted Leander with her buff also including Destroyers, becomes quite strong after her refit, effectively replacing Refitted Leander in the same builds. Shigure basically does Javelin's job better than her with having a better IJN statline before refit and her refit enabling either tanking nearly on par with Yukikaze and when teamed up with said ship, enables some offensive buffs and a torp barrage.
